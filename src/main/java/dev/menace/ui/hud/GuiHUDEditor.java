...
public class GuiHUDEditor extends GuiScreen {
    ...
    public GuiHUDEditor() {
        ...
        Collection<Element> elements = hudManager.getElements();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (Element element : hudManager.getElements()) {
            element.renderDummy();
    ...
    private void moveSelectedElement(int offsetX, int offsetY) {
        Element renderer = selectedElement.get();
    ...
    private void adjustBounds(Element renderer) {
    ...
    private static class MouseOverFinder implements Predicate<Element> {
        ...
        @Override
        public boolean test(Element renderer) {
