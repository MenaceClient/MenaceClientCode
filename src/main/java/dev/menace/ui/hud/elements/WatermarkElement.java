...
public class WatermarkElement extends Element {
    ...
    @Override
    public void render() {
        int width = this.getStringWidth("Menace | " + Minecraft.getDebugFPS() + " FPS | " + ServerUtils.getRemoteIp().split(":")[0], customFont) + 2;
        ...
        this.drawString("Menace | " + Minecraft.getDebugFPS() + " FPS | " + ServerUtils.getRemoteIp().split(":")[0], this.getPosX() + 2, this.getPosY() + 3.5, Color.WHITE.getRGB(), customFont);
    }
