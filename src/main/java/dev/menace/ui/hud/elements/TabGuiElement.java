...
public class TabGuiElement extends Element {
    ...
    public void render() {
        ...
        if (expanded) {
            ...
            int count2 = 0;
            for (Module m : Menace.instance.moduleManager.getModulesByCategory(Category.values()[currentTab])) {
    ...
    public int getHeight() {
        return Category.values().length * (this.getFontHeight(this.customFont) + 4) + 4;
    }
}
