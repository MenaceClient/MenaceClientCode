...
public class GameStatsElement extends Element {
    ...
    public void renderDummy() {
        ...
        this.drawString("Username: " + /*Menace.instance.user.getUsername()*/Minecraft.getMinecraft().session.getUsername(), this.getPosX() + 4, this.getPosY() + 20, Color.WHITE.getRGB(), this.customFont);
