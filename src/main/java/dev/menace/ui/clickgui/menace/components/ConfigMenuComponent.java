...
public class ConfigMenuComponent {
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        for (Config config : Menace.instance.configManager.getConfigs()) {
            ...
            //Draw module state
            fontRenderer.drawCenteredString(Menace.instance.configManager.getLoadedConfig() == config ? "Loaded" : "", this.x + 55 + xOffset, this.y + 112 + yOffset, Menace.instance.configManager.getLoadedConfig() == config ? Color.GREEN.getRGB() : Color.RED.getRGB());
