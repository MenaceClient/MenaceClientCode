...
public class MenaceClickGui extends GuiScreen {
    ...
    public Module settingKeybindModule;
    ...
    public final Map<Module, SettingsMenuComponent> settingsMenuComponents = new HashMap<>();
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        //Config Icon
        if (MathUtils.isMouseHovered(this.x + this.width - 100 - 25, this.y + 5, 20, 20, mouseX, mouseY)) {
