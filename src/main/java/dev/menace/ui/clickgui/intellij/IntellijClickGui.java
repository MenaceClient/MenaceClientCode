...
public class IntellijClickGui extends GuiScreen {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        if (MathUtils.isMouseHovered(this.x + 10, this.y + 10, Menace.instance.jetbrainsMono.getStringWidth("modules") + 17, Menace.instance.jetbrainsMono.getHeight(), mouseX, mouseY)) {
