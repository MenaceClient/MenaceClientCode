...
public class GuiVideoSettings extends GuiScreenOF
{
    ...
    public void initGui()
    {
        ...
        l = l + 21;
        this.buttonList.add(borderlessFullscreenButton = new GuiOptionButton(666, this.width / 2 - 100, this.height / 6 + 179, 200, 20, GameSettings.Options.BORDERLESS_FULLSCREEN, "Borderless Fullscreen: " + (!Menace.instance.borderlessFullscreen ? "Off" : "On")));
