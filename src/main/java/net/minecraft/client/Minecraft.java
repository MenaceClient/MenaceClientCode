...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void clickMouse() {
        ...
        {
            EventMouse event = new EventMouse(1);
            ...
            else
            {
                ...
                {
                    case ENTITY:
                        Menace.instance.eventManager.post(new EventAttack(this.objectMouseOver.entityHit));
    ...
    {
        EventMouse event = new EventMouse(0);
        Menace.instance.eventManager.post(event);
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        Menace.instance.eventManager.post(eventKey);
    ...
    {
        Menace.instance.eventManager.post(new EventWorldChange());
    ...
    {
        EventMouse event = new EventMouse(2);
        Menace.instance.eventManager.post(event);
