...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ)))
        {
            ...
            Menace.instance.eventManager.post(new EventUpdate());
            ...
            else
            {
                ...
                Menace.instance.eventManager.post(new EventPostMotion());
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        EventPreMotion event = new EventPreMotion(this.rotationYaw, this.rotationPitch, this.posX, this.getEntityBoundingBox().minY, this.posZ, this.onGround);
    ...
    public void moveEntity(double x, double y, double z) {
        ...
        else
        {
            ...
            {
                EventStep eventStep = new EventStep(EventStep.StepState.PRE, this.stepHeight);
                Menace.instance.eventManager.post(eventStep);
