...
import dev.menace.event.events.EventSpawnPlayer;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleSpawnPlayer(S0CPacketSpawnPlayer packetIn)
    {
        ...
        EventSpawnPlayer eventSpawnPlayer = new EventSpawnPlayer(entityotherplayermp);
        Menace.instance.eventManager.post(eventSpawnPlayer);

        if (eventSpawnPlayer.isCancelled()) {
            return;
        }
