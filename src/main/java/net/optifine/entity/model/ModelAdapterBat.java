...
public class ModelAdapterBat extends ModelAdapter
{
    ...
    public ModelRenderer getModelRenderer(ModelBase model, String modelPart)
    {
        ...
        else
        {
            ...
            return modelPart.equals("head") ? modelbat.getBatHead() : (modelPart.equals("body") ? modelbat.getBatBody() : (modelPart.equals("right_wing") ? modelbat.getBatRightWing() : (modelPart.equals("left_wing") ? modelbat.getBatLeftWing() : (modelPart.equals("outer_right_wing") ? modelbat.getBatOuterRightWing() : (modelPart.equals("outer_left_wing") ? modelbat.getBatOuterLeftWing() : null)))));
        }
    }
